...
- [ ] **Cancel task** — handler + HTTP route (domain rule exists, no use case or endpoint)
- [ ] **Soft delete** — replace hard delete with tombstone (`canceled`/`deleted` status or flag) for sync reliability
